...
export class UsersService {
  ...
  public find(filter: Partial<IUser>, pagination?: IPaginationQuery): Observable<IUser[] | IPaginationResponse<IUser>> {
  ...
  public sendWelcomeEmail(_id: string): Observable<boolean> {
