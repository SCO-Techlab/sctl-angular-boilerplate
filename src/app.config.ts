...
import { ConfigInitializerFactory, TranslateProviderFactory } from '@core/shared/factories';
import { ConfigService, ScreenService, ToastService } from '@core/shared/services';
